# com.insaneio.insane.cryptography
...
- [com.insaneio.insane](../insane.md)

## Child Packages

- [com.insaneio.insane.cryptography.abstractions](abstractions/abstractions.md): Public contracts for encoders, hashers, and encryptors.
- [com.insaneio.insane.cryptography.enums](enums/enums.md): Algorithm, encoding, key-format, and padding enums.
- [com.insaneio.insane.cryptography.extensions](extensions/extensions.md): Function-oriented API for direct `ByteArray` and `String` operations.
- [com.insaneio.insane.cryptography.serializers](serializers/serializers.md): Concrete serializers for the models in this package.
...
If you only need one-off operations such as "hash this string once" or "encrypt these bytes once", the extension API in [com.insaneio.insane.cryptography.extensions](extensions/extensions.md) is often the fastest entry point.
...
- [com.insaneio.insane.cryptography.extensions](extensions/extensions.md) for direct function-style APIs
- [com.insaneio.insane.security](../security/security.md) for TOTP support built on top of cryptography primitives
- [com.insaneio.insane.serialization](../serialization/serialization.md) for dynamic deserialization support
