# com.insaneio.insane.cryptography.extensions

This package contains the function-oriented cryptography API. If `com.insaneio.insane.cryptography` gives you reusable objects, this package gives you immediate operations over `ByteArray`, `String`, and a small set of supporting enums and encoders.

It is the fastest entry point when you do not need to keep long-lived configuration objects around.

## Parent Package

- [com.insaneio.insane.cryptography](../cryptography.md)
...
import com.insaneio.insane.cryptography.extensions.decryptAesCbc
import com.insaneio.insane.cryptography.extensions.encryptAesCbc
...
import com.insaneio.insane.cryptography.extensions.createRsaKeyPair
import com.insaneio.insane.cryptography.extensions.decryptRsaFromEncoded
import com.insaneio.insane.cryptography.extensions.encryptRsaEncoded
...
Use the concrete classes in [com.insaneio.insane.cryptography](../cryptography.md) when:
