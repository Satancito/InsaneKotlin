...
import com.insaneio.insane.cryptography.internal.AesAnsiX923Padding
import com.insaneio.insane.cryptography.internal.AesZerosPadding
...
fun ByteArray.encryptAesCbcEncoded(key: ByteArray, encoder: IEncoder, padding: AesCbcPadding = AesCbcPadding.Pkcs7): String {
    return encoder.encode(this.encryptAesCbc(key, padding))
}

@Suppress("unused")
fun ByteArray.encryptAesCbcEncoded(key: String, encoder: IEncoder, padding: AesCbcPadding = AesCbcPadding.Pkcs7): String {
    return encoder.encode(this.encryptAesCbc(key, padding))
}

fun String.encryptAesCbcEncoded(key: ByteArray, encoder: IEncoder, padding: AesCbcPadding = AesCbcPadding.Pkcs7): String {
    return encoder.encode(this.encryptAesCbc(key, padding))
}

@Suppress("unused")
fun String.encryptAesCbcEncoded(key: String, encoder: IEncoder, padding: AesCbcPadding = AesCbcPadding.Pkcs7): String {
    return encoder.encode(this.encryptAesCbc(key, padding))
}

fun String.decryptAesCbcFromEncoded(key: ByteArray, encoder: IEncoder, padding: AesCbcPadding = AesCbcPadding.Pkcs7): ByteArray {
    return encoder.decode(this).decryptAesCbc(key, padding)
}

@Suppress("unused")
fun String.decryptAesCbcFromEncoded(key: String, encoder: IEncoder, padding: AesCbcPadding = AesCbcPadding.Pkcs7): ByteArray {
    return encoder.decode(this).decryptAesCbc(key, padding)
}
